...
@tool
def search_hotel_price(hotel_name: str, city: str) -> Dict[str, Any]:
    """Search the web for approximate nightly price of a specific hotel."""
    return _web.search_hotel_price(hotel_name, city)